		...
		'diamonds' => [
			...
			'blocks' => [
				...
				'shop_engagement_rings' => [
					...
					'export_name' => 'ShopEngagementRings',
					'props'       => '',
				],
			],
		],
		...
		'custom_design' => [
			...
			'blocks' => [
				...
				'describe_your_design' => [
					...
					'export_name' => 'DescribeYourDesign',
					'props'       => '',
				],
				'calculator' => [
		...
		'engagement' => [
			...
			'blocks' => [
				'choose_ring_styles' => [
					...
					'import_path' => '@/widgets/engagement-rings/choose-ring-styles',
					'export_name' => 'ChooseRingStyles',
					'props'       => '',
				],
				'choose_your_diamond' => [
					'label'       => __( 'Choose Your Diamond', 'seo-generator' ),
					'description' => __( 'Diamond selection guide for rings', 'seo-generator' ),
					'import_path' => '@/widgets/engagement-rings/choose-your-diamond',
				...
				'choose_diamond_color' => [
					...
					'import_path' => '@/widgets/engagement-rings/сhoose-diamond-color',
					'export_name' => 'ChooseDiamondColor',
					'props'       => '',
				],
				'metals_selector' => [
				...
				'rings_why_choose' => [
					...
					'import_path' => '@/widgets/engagement-rings/rings-why-choose',
					'export_name' => 'RingsWhyChoose',
					'props'       => '',
				],
				'complete_experience' => [
				...
				'lifestyle' => [
					...
					'import_path' => '@/widgets/engagement-rings/lifestyle',
